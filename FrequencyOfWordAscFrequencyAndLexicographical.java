...
public class FrequencyOfWordAscFrequencyAndLexicographical {
    ...
    static Map<String, Integer> solution1(String string) {
    ...
    static Map<String, Long> solution2(String string) {
    ...
    public static void main(String[] args) {
        ...
        solution2(str).forEach((k, v) -> System.out.println(k + " - " + v));
        System.out.println("----------");
        Map<String, Integer> stringIntegerMap = solution1(str);
